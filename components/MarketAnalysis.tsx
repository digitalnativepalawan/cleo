...
const Card = ({ icon, title, children, iconTooltip }: { icon: React.ReactNode, title: string, children: React.ReactNode, iconTooltip?: string }) => (
    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 flex flex-col space-y-3">
        <div className="flex items-center space-x-3 h-14 flex-shrink-0">
            <div className="relative group text-[#0A84FF] h-6 w-6">
                {icon}
                {iconTooltip && (
            ...
            <h3 className="font-serif text-xl font-normal text-[#121212]">{title}</h3>
        </div>
        <div className="flex-grow flex flex-col space-y-3 text-sm text-[#5B6470]">
            {children}
        </div>
    </div>
);
    ...
    return (
        <div className="flex-grow flex flex-col">
            ...
            <div className="lg:hidden space-y-3 text-sm">
                {data.map(row => (
                    <div key={row.feature} className="p-4 rounded-xl border border-gray-200 bg-white shadow-sm">
                        <h4 className="font-semibold text-gray-900 mb-2">{row.feature}</h4>
...
const TargetDemographics: React.FC = () => {
    ...
    return (
        <article className="rounded-2xl border border-gray-200 bg-white shadow-sm p-6 flex flex-col">
            <header className="mb-4">
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        <h3 className="font-serif text-xl font-normal text-gray-900">Target Demographics</h3>
                        <p className="text-sm text-gray-500 mt-1">Illustrative segment mix of investors and users by 2030.</p>
                    </div>
                </div>
            </header>
                    ...
                    <Card icon={<ShieldCheckIcon />} title="Regulatory Advantage" iconTooltip="Signifies robust legal and regulatory compliance, a key de-risking factor.">
                        <div className="space-y-4">
                            <div className="flex items-start space-x-3">
                                ...
                                <div>
                                    <h4 className="font-semibold text-[#121212]">SEC, ECC & TIEZA Compliance</h4>
                            ...
                            <div className="flex items-start space-x-3">
                                ...
                                <div>
                                    <h4 className="font-semibold text-[#121212]">TIEZA Investment Incentives</h4>
                                    <ul className="text-xs text-gray-600 mt-1 space-y-1 list-disc list-inside pl-1">
                            ...
                            <div className="flex items-start space-x-3">
                                ...
                                <div>
                                    <h4 className="font-semibold text-[#121212]">SIRV-Linked Residency Investment</h4>
                                    <ul className="text-xs text-gray-600 mt-1 space-y-1 list-disc list-inside pl-1">
                            ...
                            <div className="flex items-start space-x-3">
                                ...
                                <div>
                                    <h4 className="font-semibold text-[#121212]">Foreign & Filipino Benefits</h4>
                                    <ul className="text-xs text-gray-600 mt-1 space-y-1 list-disc list-inside pl-1">
