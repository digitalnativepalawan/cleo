            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {INITIAL_PROJECTS.map(project => (
                    <button 
                        ...
                        className="p-5 border border-gray-200 rounded-lg text-left hover:bg-gray-50 hover:border-blue-500 hover:shadow-md transition-all group focus:outline-none focus:ring-2 focus:ring-blue-500"
                    >
