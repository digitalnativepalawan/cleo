...
const BlogPostCard: React.FC<{ post: BlogPost; onSelect: () => void; }> = ({ post, onSelect }) => {
    return (
        <div 
            onClick={onSelect} 
            className="group cursor-pointer bg-[var(--bg-primary)] rounded-lg shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col"
            role="article"
    ...
    return (
        <div className="animate-fade-in">
            <div className="max-w-3xl mx-auto px-4 sm:px-6 py-24 sm:py-32">
                 <button 
                    onClick={onBack} 
                    className="flex items-center gap-2 text-sm font-medium text-[var(--accent-primary)] hover:opacity-80 transition-colors mb-8"
                 >
                ...
                <article>
                    <header className="mb-8">
                        <h1 className="font-sans text-3xl sm:text-4xl font-semibold text-[var(--text-primary)] mb-3 tracking-tight leading-tight">{post.title}</h1>
...
const BlogPage: React.FC<{ posts: BlogPost[]; }> = ({ posts }) => {
    ...
    return (
        <section className="bg-[var(--bg-secondary)]/70 py-24 sm:py-32 animate-fade-in">
            <div className="container mx-auto px-6">
                ...
                {publishedPosts.length > 0 ? (
                    ...
                    <div className="text-center py-16 bg-[var(--bg-primary)] rounded-lg border">
